<!-- resources/views/layouts/employees.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="header">
            <div class="header-left">
                <h1>@yield('page-title', 'Employee Management')</h1>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Mobile menu toggle (you can add a hamburger menu button in header if needed)
            // Example: 
