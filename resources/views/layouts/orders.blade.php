<!-- resources/views/layouts/orders.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Louies Dressed Chicken - Order Management</title>
    ...
    <style>
        ...
        * {
        ...
        /* Table Styles - UPDATED for consistency */
        .table {
            margin-bottom: 0;
            border-radius: 8px;
            overflow: hidden;
...
.customer-pending-order:hover {
    background-color: #e9ecef;
    border-color: #0d6efd;
}

.customer-pending-order.selected {
    background-color: #e7f1ff;
    border-color: #0d6efd;
}

.customer-pending-order input[type="radio"] {
    margin-right: 8px;
}

.customer-pending-order label {
    cursor: pointer;
    margin-bottom: 0;
}
...
<body>
        ...
        <div class="sidebar-header">
            <div class="logo-container">
                <div class="logo" style="width: 150px; height: 150px; border-radius: 0; background: transparent; border: none; box-shadow: none;">
                    ...
                    <img src="{{ asset('images/logo.png') }}" alt="Louies Dressed Chicken" style="width: 200%; height: 200%; object-fit: contain; border-radius: 0;" onerror="this.style.display='none'">
                </div>
            </div>
        </div>
    ...
    <!-- Add this script section for dynamic page titles -->
    <script>
