        ...
        <form action="{{ route('inventory.update', $inventory) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('product_name') is-invalid @enderror" 
                               id="product_name" name="product_name" value="{{ old('product_name', $inventory->product_name) }}" required>
                        @error('product_name')
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('product_code') is-invalid @enderror" 
                               id="product_code" name="product_code" value="{{ old('product_code', $inventory->product_code) }}" required>
                        @error('product_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                @if($inventory->image)
                    <div class="mt-2">
                        ...
                        <img src="{{ asset('storage/' . $inventory->image) }}" 
                             ...
                             style="max-width: 200px; max-height: 200px; border-radius: 4px; border: 1px solid #dee2e6;">
                    </div>
                @endif
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('cost_price') is-invalid @enderror" 
                               id="cost_price" name="cost_price" value="{{ old('cost_price', $inventory->cost_price) }}" required min="0">
                        @error('cost_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('selling_price') is-invalid @enderror" 
                               id="selling_price" name="selling_price" value="{{ old('selling_price', $inventory->selling_price) }}" required min="0">
                        @error('selling_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('unit') is-invalid @enderror" 
                            ...
                            <option value="g" {{ old('unit', $inventory->unit) == 'g' ? 'selected' : '' }}>Grams</option>
                            <option value="l" {{ old('unit', $inventory->unit) == 'l' ? 'selected' : '' }}>Liters</option>
                            <option value="pack" {{ old('unit', $inventory->unit) == 'pack' ? 'selected' : '' }}>Packs</option>
                            <option value="box" {{ old('unit', $inventory->unit) == 'box' ? 'selected' : '' }}>Boxes</option>
                        </select>
                        @error('unit')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" 
                               id="quantity" value="{{ $inventory->quantity }} {{ $inventory->unit }}" readonly>
                        <small class="form-text text-muted">
                            <i class="fas fa-info-circle me-1"></i>
                            Use Stock In/Stock Out pages to adjust quantity
                        </small>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('low_stock_alert') is-invalid @enderror" 
                               id="low_stock_alert" name="low_stock_alert" value="{{ old('low_stock_alert', $inventory->low_stock_alert) }}" required min="0">
            ...
            <div class="mb-3">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $inventory->is_active) ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    costPriceInput.addEventListener('input', function() {
        ...
        if (costPrice > 0 && (!sellingPriceInput.value || parseFloat(sellingPriceInput.value) <= costPrice)) {
